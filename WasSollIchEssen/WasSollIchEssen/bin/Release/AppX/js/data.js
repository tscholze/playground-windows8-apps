(function () {
    ...
    function getFeeds() {
        ...
        locations = [
                {
                    key: "thisWeekM",
                    url: 'http://www.hs-augsburg.de/~hippi/mensa/current_fried.xml',
                    name: 'Mensa M',
    ...
    function getItemsFromXml(articleSyndication, dishPosts, feed) {
        ...
        for (var dayIndex = 0; dayIndex < days.length; dayIndex++) {
            ...
            var dishes = day.querySelectorAll("food");
            ...
            for (var postIndex = 0; postIndex < dishes.length; postIndex++) {
                ...
                var priceStudent = dish.querySelector("price > student").textContent;

                // Hole Preis fuer Angestellte und Andere.
                var priceOthers = dish.querySelector("price > normal").textContent;
